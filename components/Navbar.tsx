          ...
          <>
            <div className="fixed h-screen left-0 right-0 top-0 shadow-lg z-50 bg-white">
              <div className="flex justify-between items-center px-4 sm:px-6 lg:px-8 py-6">
                <h1 className="text-3xl text-black">BAWA</h1>
                <IoMdClose
                  onClick={toggleMenu}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center space-x-4">
                <button
                  className="hidden md:flex md:bg-[#000011] text-white md:px-4 md:rounded-md md:py-1.5 cursor-pointer hover:translate-0.5 hover:transition delay-150 duration-300 ease-in-out"
